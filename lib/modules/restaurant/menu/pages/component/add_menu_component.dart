                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFieldInputComponent(
                                    ...
                                    txtController: controller.lsFormMenu[index]
                                        [0]),
                                TextFieldInputComponent(
                                    title: 'Subtitle',
                                    keyboardType: TextInputType.text,
                                ...
                                Padding(
                                  ...
                                  child: Align(
                                      ...
                                      child: RichText(
                                        text: TextSpan(
                                          text: 'Category',
                                          style: ThemeConfig().textHeader4Thin(
                                              color: Colors.black),
                                          children: <TextSpan>[
                                            TextSpan(
                                                text: '*',
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              color: Colors.grey,
                                              borderRadius: BorderRadius.all(Radius.circular(ThemeConfig()
                                                  .defaultSpacing))),
                                          child: Obx(() => ClipRRect(
                                              borderRadius: BorderRadius.all(Radius.circular(ThemeConfig()
                                                  .defaultSpacing)),
                                              child: controller.lsPic[index] != ''
                                                  ? Image.file(File(controller.lsPic[index]), fit: BoxFit.fill)
